...
//    let cases:  [(QueryComponentRepresentable, QueryComponentRepresentable)]
//    let _else: QueryComponentRepresentable
//    public init(_ cases: [(QueryComponentRepresentable, QueryComponentRepresentable)], _else: QueryComponentRepresentable) {
//        self.cases = cases
//        self._else = _else
//    }
